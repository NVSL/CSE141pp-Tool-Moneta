...
from cse142.settings import newc, COMP_W_MISS, COMP_R_MISS, WRITE_MISS, READ_MISS, WRITE_HIT, READ_HIT, LEGEND_MEM_ACCESS_TITLE, LEGEND_TAGS_TITLE, LEGEND_CLICK_ZOOM, LEGEND_STATS_TITLE, INDEX, ADDRESS
from cse142.moneta.legend.accesses import Accesses
from cse142.moneta.legend.tags import Tags
from cse142.moneta.legend.click_zoom import Click_Zoom
from cse142.moneta.legend.stats import PlotStats

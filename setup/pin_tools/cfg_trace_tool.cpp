...
using namespace std;
ofstream outfile("/home/jovyan/work/moneta/cfg_output/out_graph");
ofstream outfile2("/home/jovyan/work/moneta/cfg_output/format_graph");
set<string> visited;
bool reached_main = false;

const string START_FUNC = "CFG_START";
const string STOP_FUNC = "CFG_STOP";

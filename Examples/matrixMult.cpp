...
#define START(x,y) DUMP_ACCESS(x,y,1); DUMP_ACCESS_START(x,y); DUMP_ACCESS_START_TAG("Matrix 1",x,y);
#define STOP(x,y) DUMP_ACCESS(x,y,0); DUMP_ACCESS_STOP(); DUMP_ACCESS_STOP_TAG("Matrix 1");
...
DUMP_ACCESS_START_TAG("Matrix 2", &data2[0][0], &data2[NB-1][NC-1]);
